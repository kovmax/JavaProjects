...
public class MatrixMultiplying {
    ...
    public MatrixMultiplying(final Matrix m1, final Matrix m2, final int nTh) throws MatrixException {
        if (m1.getColumns() != m2.getRows())
            throw new MatrixException("Inappropriate matrix's dimensions");
        this.matrix1 = m1;
        this.matrix2 = m2;
        this.nThreads = nTh;
    }
    ...
    public Matrix multiply() {
        final Matrix result = new Matrix(matrix1.getRows(), matrix2.getColumns());
